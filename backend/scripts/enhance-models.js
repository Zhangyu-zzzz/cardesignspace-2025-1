 ...
 * 更新models表中的type、specs、description、styleTags字段
 */
...
class ModelEnhancer {
  ...
  async getModelInfo(modelName, brandName) {
    const prompt = `请为汽车车型"${brandName} ${modelName}"提供详细的JSON格式信息。
